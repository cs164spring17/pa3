...
class TransformationStep {
     ...
     * @param lexer               The lexer for both {@code pattern} and {@code replacementTemplate}
     */
    TransformationStep(String pattern, Function<Object[], Object[]> pureModifier, String replacementTemplate, Lexer lexer) {
        this.pattern = Pattern.parse(pattern, lexer);
        ...
        if (replacementTemplate != null)
            this.replacementTemplate = Template.parse(replacementTemplate, lexer);
    }
     ...
     * @param lexer               The lexer for both {@code pattern} and {@code replacementTemplate}
     */
    TransformationStep(String pattern, Consumer<Object[]> modifier, String replacementTemplate, Lexer lexer) {
        this.pattern = Pattern.parse(pattern, lexer);
        if (modifier != null) {
     ...
     * @param lexer          The lexer for both {@code pattern} and {@code replacementTemplate}
     */
    TransformationStep(String pattern, Function<Object[], Object> directModifier, Lexer lexer) {
        this.pattern = Pattern.parse(pattern, lexer);
     ...
     * @param lexer               The lexer for both {@code pattern} and {@code replacementTemplate}
     */
    TransformationStep(String pattern, BiFunction<Object[], Object, Object[]> pureModifier, String replacementTemplate, Lexer lexer) {
        this.pattern = Pattern.parse(pattern, lexer);
        this.modifier = pureModifier;
     ...
     * @param lexer               The lexer for both {@code pattern} and {@code replacementTemplate}
     */
    TransformationStep(String pattern, BiConsumer<Object[], Object> modifier, String replacementTemplate, Lexer lexer) {
        this.pattern = Pattern.parse(pattern, lexer);
        this.modifier = modifier;
     ...
     * @param lexer          The lexer for both {@code pattern} and {@code replacementTemplate}
     */
    TransformationStep(String pattern, BiFunction<Object[], Object, Object> directModifier, Lexer lexer) {
        this.pattern = Pattern.parse(pattern, lexer);
        this.modifier = directModifier;
